#!/usr/bin/env python3
"""Resume batch-processing the Cleaning Up episodes that failed in the first pass
due to a transient network drop (Ep254 onward through Deep Dive Australia 04)."""
...
if __name__ == "__main__":
    ...
    for i, (video_id, title) in enumerate(EPISODES, 1):
        print(f"\n[{i}/{len(EPISODES)}] {title[:70]}...", flush=True)
        try:
